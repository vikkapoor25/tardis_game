...
VALUES
    ('Where are we?', 'Invention of the Steam Engine', 'The Industrial Revolution (1760-1840)'),
    ('What''s going on?', 'The Railway Revolution', 'The Industrial Revolution (1760-1840)'),
    ('How''s this possible?', 'Child Labour and Factory Conditions', 'The Industrial Revolution (1760-1840)');
...
VALUES
    ...
    (2, 'The engine''s going to be used on one of those famous trains built by George Stephenson! What was the name of it again?',
    ...
    (3, 'We''ve had kids filling the numbers for years now. Shame we can''t get as many in as we used to. Lots of them were under thirteen, but bloody Parliament brought in a new law stopping them from working. What was that act called again?',
